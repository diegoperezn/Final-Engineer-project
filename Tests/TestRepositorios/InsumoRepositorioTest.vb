...
'''<summary>
'''This is a test class for InsumoRepositorioTest and is intended
'''to contain all InsumoRepositorioTest Unit Tests
'''</summary>
<TestClass()> _
Public Class InsumoRepositorioTest
...
#End Region
    ...
    Dim target As InsumoRepositorio = RepositorioFactory.insumoRepositorio
    ...
    Public Sub grabarInsumoTest()
        ...
        insumo.movimientosStock.Add(New MovimientosStock(Nothing, insumo, 100, DateTime.Now, New TipoMovimiento(1)))
