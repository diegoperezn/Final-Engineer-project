...
'''<summary>
'''This is a test class for FacturaRepositorioTest and is intended
'''to contain all FacturaRepositorioTest Unit Tests
'''</summary>
<TestClass()> _
...
#End Region
    ...
    Dim target As FacturaRepositorio = RepositorioFactory.facturaRepositorio
