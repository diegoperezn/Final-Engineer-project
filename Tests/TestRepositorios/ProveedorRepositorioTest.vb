...
'''<summary>
'''This is a test class for ProveedorRepositorioTest and is intended
'''to contain all ProveedorRepositorioTest Unit Tests
'''</summary>
<TestClass()> _
...
#End Region
    ...
    Dim target As ProveedorRepositorio = RepositorioFactory.proveedorRepositorio
