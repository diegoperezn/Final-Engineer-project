...
'''<summary>
'''This is a test class for OrdenCompraRepositorioTest and is intended
'''to contain all OrdenCompraRepositorioTest Unit Tests
'''</summary>
<TestClass()> _
Public Class OrdenCompraRepositorioTest
...
#End Region
    ...
    Dim target As OrdenCompraRepositorio = RepositorioFactory.ordenCompraRepositorio
