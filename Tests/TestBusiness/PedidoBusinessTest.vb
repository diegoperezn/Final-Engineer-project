...
'''<summary>
'''This is a test class for PedidoBusinessTest and is intended
'''to contain all PedidoBusinessTest Unit Tests
'''</summary>
<TestClass()> _
...
#End Region
    ...
    Dim target As PedidoBusiness = BusinessFactory.pedidoBusiness
    ...
    Public Sub actualizarPedidoTest()
        ...
        Dim pedidoNuevo As New Pedido(Nothing, "comentario test", New List(Of HistoricoEstados), New TipoPedido(2),
                                 produccion, New Cliente(2), New EstadoPedido(2), DateTime.Now, DateTime.Now)
        produccion(0).pedido = pedidoNuevo

        target.GuardarPedido(pedidoNuevo)
    ...
    '''<summary>
    '''A test for GuardarPedido
    '''</summary>
    <TestMethod()> _
    Public Sub GuardarPedidoTest()
        ...
        Assert.AreEqual(1, pedido.historicoEstados.Count)
        Assert.AreEqual(Long.Parse(2), pedido.historicoEstados(0).estado.estadoPedido)
    End Sub
    ...
    '''</summary>
    <TestMethod()> _
    Public Sub GuardarPedidoTest1()
        Dim produccion As New List(Of Produccion)
        produccion.Add(New Produccion(Nothing, "com1", Nothing, New Maquina(2), 10, New Articulo(1), Nothing, Nothing, New EstadoTrabajos(1), DateTime.Now, Nothing, 1))


        target.GuardarPedido("comentario test", New List(Of HistoricoEstados), New TipoPedido(2),
                                 produccion, New Cliente(2), New EstadoPedido(2), DateTime.Now, DateTime.Now)
    ...
    '''<summary>
    '''A test for CambiarEstadpPedido
    '''</summary>
    <TestMethod()> _
    Public Sub CambiarEstadoPedidoTest()
        Dim produccion As New List(Of Produccion)
        produccion.Add(New Produccion(Nothing, "com1", Nothing, New Maquina(2), 10, New Articulo(1), Nothing, Nothing, New EstadoTrabajos(1), DateTime.Now, Nothing, 1))

        Dim pedidoNuevo As New Pedido(Nothing, "comentario test", New List(Of HistoricoEstados), New TipoPedido(2),
                                 produccion, New Cliente(2), New EstadoPedido(1), DateTime.Now, DateTime.Now)
        produccion(0).pedido = pedidoNuevo
        ...
        Assert.AreEqual(1, pedido.historicoEstados.Count)
        Assert.AreEqual(1, pedido.trabajos.Count)
        Assert.AreEqual(Long.Parse(1), pedido.estadoActual.estadoPedido)
        Assert.IsNotNull(pedido.fechaInicio)
        Assert.IsNotNull(pedido.fechaFinal)

        pedido.comentario = "comentario Modificado"

        target.CambiarEstadpPedido(New EstadoPedido(2), pedido)
        ...
        Assert.AreEqual(2, pedido.historicoEstados.Count)
        Assert.IsNotNull(pedido.historicoEstados(0).fechaHasta)
        Assert.AreEqual(Long.Parse(2), pedido.historicoEstados(1).estado.estadoPedido)
    End Sub
