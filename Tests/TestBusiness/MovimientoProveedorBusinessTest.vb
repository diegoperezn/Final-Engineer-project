...
'''<summary>
'''This is a test class for MovimientoProveedorBusinessTest and is intended
'''to contain all MovimientoProveedorBusinessTest Unit Tests
'''</summary>
<TestClass()> _
Public Class MovimientoProveedorBusinessTest
...
#End Region
    ...
    Dim target As MovimientoProveedorBusiness = BusinessFactory.movimientoProveedorBusiness
