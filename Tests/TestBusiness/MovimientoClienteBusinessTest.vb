...
'''<summary>
'''This is a test class for MovimientoClienteBusinessTest and is intended
'''to contain all MovimientoClienteBusinessTest Unit Tests
'''</summary>
<TestClass()> _
Public Class MovimientoClienteBusinessTest
...
#End Region
    ...
    Dim target As MovimientoClienteBusiness = BusinessFactory.movimientoClienteBusiness
