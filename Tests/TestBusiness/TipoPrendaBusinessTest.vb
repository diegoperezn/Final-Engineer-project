...
'''<summary>
'''This is a test class for TipoPrendaBusinessTest and is intended
'''to contain all TipoPrendaBusinessTest Unit Tests
'''</summary>
<TestClass()> _
Public Class TipoPrendaBusinessTest
...
#End Region
    ...
    Dim target As TipoPrendaBusiness = BusinessFactory.tipoPrendaBusiness
